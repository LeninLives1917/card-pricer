<script lang="ts">
  // Admin landing — links to overview, users, arbitrage. Sub-pages port in week 4.
</script>

<svelte:head>
  <title>Admin · Card Pricer</title>
</svelte:head>
...
<style>
  ...
  .link:hover { background: var(--ink-300); border-color: var(--ink-500); }
</style>
