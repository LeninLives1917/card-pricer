...
export function extractCardNumber(text) {
  ...
  if (regSlash) {
    return { reg_mark: regSlash[1], number: `${regSlash[2]}/${regSlash[3]}`, game: 'pokemon' };
  }
  ...
  if (gg) {
    return { set_code: 'CZGG', number: gg[1], game: 'pokemon' };
  }
